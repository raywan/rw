...
{
  assert(ABS(m->e[0][0] - t00) < EPSILON);
  assert(ABS(m->e[0][1] - t01) < EPSILON);
  assert(ABS(m->e[0][2] - t02) < EPSILON);
  assert(ABS(m->e[0][3] - t03) < EPSILON);
  assert(ABS(m->e[1][0] - t10) < EPSILON);
  assert(ABS(m->e[1][1] - t11) < EPSILON);
  assert(ABS(m->e[1][2] - t12) < EPSILON);
  assert(ABS(m->e[1][3] - t13) < EPSILON);
  assert(ABS(m->e[2][0] - t20) < EPSILON);
  assert(ABS(m->e[2][1] - t21) < EPSILON);
  assert(ABS(m->e[2][2] - t22) < EPSILON);
  assert(ABS(m->e[2][3] - t23) < EPSILON);
  assert(ABS(m->e[3][0] - t30) < EPSILON);
  assert(ABS(m->e[3][1] - t31) < EPSILON);
  assert(ABS(m->e[3][2] - t32) < EPSILON);
  assert(ABS(m->e[3][3] - t33) < EPSILON);
}
